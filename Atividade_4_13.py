    ...
    for letra_2 in letras:
            if letra_2 != letra_1:
                for letra_3 in letras:
                    if letra_3 != letra_2 and letra_3 != letra_1:
                        for letra_4 in letras:
                            if letra_4 != letra_3 and letra_4 != letra_2 and letra_4 != letra_1:
                                for letra_5 in letras:
                                     if letra_5 != letra_4 and letra_5 != letra_3 and letra_5 != letra_2 and letra_5 != letra_1:
                                        for letra_6 in letras:
                                            if letra_6 != letra_5 and letra_6!= letra_4 and letra_6 != letra_3 and letra_6 != letra_2 and letra_6 != letra_1:
